...
#ifndef TIER1_RICE_EXPORTS_INCLUDED
#define TIER1_RICE_EXPORTS_INCLUDED

//
// The following block is the standard way of creating macros which make exporting
// from a DLL simpler. All files within this DLL are compiled with the TIER1_RICE_EXPORTS
// symbol defined on the command line. this symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see
// TIER1_RICE_API functions as being imported from a DLL, wheras this DLL sees symbols
// defined with this macro as being exported.
//

#if defined(_WIN32) && defined(MOJA_DLL)
#if defined(TIER1_RICE_EXPORTS)
#define TIER1_RICE_API __declspec(dllexport)
#else
#define TIER1_RICE_API __declspec(dllimport)
#endif
#endif

#if !defined(TIER1_RICE_API)
#if !defined(TIER1_RICE_NO_GCC_API_ATTRIBUTE) && defined (__GNUC__) && (__GNUC__ >= 4)
#define TIER1_RICE_API __attribute__ ((visibility ("default")))
#else
#define TIER1_RICE_API
#endif
#endif

//
// Automatically link moja.modules.tier1_rice library.
//
#if defined(_MSC_VER)
#if !defined(MOJA_NO_AUTOMATIC_LIBS) && !defined(TIER1_RICE_EXPORTS)
#pragma comment(lib, "moja.modules.tier1_rice" MOJA_LIB_SUFFIX)
#endif
#endif

#endif // TIER1_RICE_EXPORTS_INCLUDED
