...
class RiceHarvestEvent;

class TIER1_RICE_API DisturbanceEventHandler {
  public:
   virtual ~DisturbanceEventHandler() {}
   virtual void simulate(const RiceHarvestEvent& harvest) {}

};

class TIER1_RICE_API DisturbanceEventBase : public flint::EventBase {
  public:
...
class TIER1_RICE_API DisturbanceEventsList {
  public:
